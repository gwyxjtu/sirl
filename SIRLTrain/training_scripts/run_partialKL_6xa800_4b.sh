#!/bin/bash
# Partial-KL PPO training on 6× A800 (80GB each) with Qwen3-4B-Instruct-2507
...
#     bash training_scripts/run_partialKL_6xa800_4b.sh
#
# Full run:
...
project_name='SIRL'
exp_name='partialKL_6xa800_qwen3_4b'
