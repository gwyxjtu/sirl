...
def kl_penalty(logprob: torch.FloatTensor, ref_logprob: torch.FloatTensor, kl_penalty) -> torch.FloatTensor:
    ...
    Returns:
    """
    #cyt-start-- chenyitian@shanshu.ai
    print("Debug KL divergence and design new framework by chenyitian@shanshu.ai")
    print(f"The shape of logprob {logprob.shape}")
    print(logprob)
    print(f"The shape of ref_logprob {ref_logprob.shape}")
    print(ref_logprob)
    ##cyt-end
